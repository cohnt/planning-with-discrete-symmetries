...
while len(qs) < 2:
    q = Sampler(1).flatten()
    if len(qs) < 1:
        q[0:15] = [19.80448543, 16.39716394, -0.54537461, 17.5253531,  16.47518865, -2.79931923, 14.37274473, 16.04341125,  1.48538675, 14.18263502, 10.81873709, -2.35729924, 19.15294591,  8.06512597, -1.77844831]
