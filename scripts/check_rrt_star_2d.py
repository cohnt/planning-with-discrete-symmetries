...
visualization.draw_graph(meshcat, planner.tree, [0,1], path="symmetry-rrt", color=Rgba(0, 0, 0, 1), linewidth=linewidth, draw_caps=False)
...
visualization.draw_graph(meshcat, planner2.tree, [0,1], path="baseline-rrt", color=Rgba(0.5, 0, 0, 1), linewidth=linewidth, draw_caps=False)
...
visualization.draw_graph(meshcat, planner.tree, [0,1], path="symmetry-rrt-star", color=Rgba(0, 0.5, 0, 1), linewidth=linewidth, draw_caps=False)
...
visualization.draw_graph(meshcat, planner2.tree, [0,1], path="baseline-rrt-star", color=Rgba(0, 0, 1, 1), linewidth=linewidth, draw_caps=False)
